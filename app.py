...
app = Flask(__name__)
app.secret_key = ' 8ad790d4d56b91b3c4e7e6fdef5be8937f94a10f1930af9ea50a2a00a67ff3c4'
UPLOAD_FOLDER = '/Users/albert/IdeaProjects/FitTrack/iimmmge'
...
TWILIO_ACCOUNT_SID = params.get('twilio_account_sid', '')
TWILIO_AUTH_TOKEN = params.get('twilio_auth_token', '')
    ...
    if 'user' in session:
        ...
        if request.method == 'POST':
            ...
            if photo_file and photo_file.filename:
                ...
                photo_url = '/' + save_path.replace('\\', '/')  # For web/static serving
